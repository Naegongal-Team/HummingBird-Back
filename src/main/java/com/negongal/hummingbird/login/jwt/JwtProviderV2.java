package com.negongal.hummingbird.login.jwt;

import com.negongal.hummingbird.login.oauth2.CustomUserDetail;
...
public class JwtProviderV2 {
    ...
    @Autowired
    public JwtProviderV2(@Value("${auth.token.secret-key}")String secretKey, @Value("${auth.token.refresh-cookie-key}")String cookieKey, UserRepository userRepository) {
