...
class PerformanceServiceTest {
	...
	@Mock
	private PerformanceDateRepository dateRepository;
	@Mock
	...
	class searchPerformance {
		...
		void searchPerformanceByArtistNameTest() {
			//given
			PerformanceSearchRequestDto requestDto = PerformanceSearchRequestDto.builder()
			...
			assertThat(dtoPage.getTotalElements()).isEqualTo(performancePageDto.getTotalElements());
			assertThat(dtoPage.getContent().size()).isEqualTo(performancePageDto.getPerformanceDtos().size());
			assertThat(requestDto.getArtistName()).isEqualTo(
				performancePageDto.getPerformanceDtos().get(0).getArtistName());
		}
	}
